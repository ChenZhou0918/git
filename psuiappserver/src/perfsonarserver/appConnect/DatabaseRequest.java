...
//				currentUtilValue.add("Direction",util_list.get(0).getDirection());
			 ...
			 System.out.println("Utilization service doesn't work");
			 currentUtilValue.add("Service", "");
			 currentUtilValue.add("HighestPercentage","");
			 responseValues.add(currentUtilValue);
			}
...
//				currentDelayValue.add("DestInterface",delay_list.get(0).getDestInterface());
				...
				System.out.println("DJL service doesn't work");
				currentDelayValue.add("Service", "");
				currentDelayValue.add("HighestPercentage","");
				responseValues.add(currentUtilValue);
				}
...
//				currentJitterValue.add("DestInterface", jitter_list.get(0).getDestInterface());
			...
			responseValues.add(currentThroughValue);}
				...
				System.out.println("Throughput service doesn't work");
				currentThroughValue.add("Service","");
				currentThroughValue.add("HighestThroughput","");
				responseValues.add(currentUtilValue);
				}
...
//				Database request;
		...
		case "ThroughputGetData":
			...
			else
			{
				...
				//	currentValue.add("date", item.getTimestampString());
					currentValue.add("date", DataAccess.convertDateToString(item.getTimestamp()));
