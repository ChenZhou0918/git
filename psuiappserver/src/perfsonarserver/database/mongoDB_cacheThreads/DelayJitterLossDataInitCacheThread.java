 ...
 * 
 */
public class DelayJitterLossDataInitCacheThread extends Thread
{
	/** service name */
	 ...
	 *            cache
	 */
	public DelayJitterLossDataInitCacheThread( String serviceName, long startTime, long endTime, String srcInterface, String destInterface, DJLCache cache)
	{
	...
	public void run()
	{
		try
		{
			System.out.println("Init DJLData: " + serviceName + " " + srcInterface + "-" + destInterface + " " + startTime + "-" + endTime + " " + DataAccess.convertDateToString(System.currentTimeMillis()));
			cache.checkDataCache(serviceName, startTime, endTime, srcInterface, destInterface, true);
			System.out.println("Ende Init DJLData: " + serviceName + " " + srcInterface + "-" + destInterface + " " + startTime + "-" + endTime + " " + DataAccess.convertDateToString(System.currentTimeMillis()));
		}
