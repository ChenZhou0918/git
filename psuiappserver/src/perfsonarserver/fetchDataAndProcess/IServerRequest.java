...
import perfsonarserver.fetchDataAndProcess.transferObjects.*;
...
public interface IServerRequest
{
	...
	public List<UtilizationData> getTopFiveUtilization(String serviceURL,long aktStart, long aktEnd) throws FetchFailException;
	

	public List<DelayJitterLossData> getTopFiveDelay(String serviceURL,
			long aktStart, long aktEnd) throws FetchFailException;

	public List<DelayJitterLossData> getTopFiveJitter(String serviceURL,
			long aktStart, long aktEnd) throws FetchFailException;

	List<ThroughputData> getThroughputData(String serverURL,
			ThroughputInterfacePair tpI, long startTime, long endTime)
			throws FetchFailException;

	public List<DelayJitterLossInterfacePair> getTopLossInterfaces(
			String serviceURL, long aktStart, long aktEnd) throws FetchFailException;

	public List<ThroughputData> getTopFiveThroughput(String serviceURL,
			long aktStart, long aktEnd)throws FetchFailException;;
