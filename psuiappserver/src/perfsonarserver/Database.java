...
//	public Database()
	...
	public static void start(Scanner scan)
	{
		request = new RequestTO();
		{
			...
			request.setStartDate("2014-03-31 23-00-00-000");
			request.setEndDate("2014-03-31 23-59-00-000");
			request.setFeatureName("");
			request.setGetNonCached(true);
			request.setService("X-WiN");
		}
		Database start = new Database();
		List<DelayJitterLossDataTO> list;
		try {
...
//	}
	...
	private class MyThread extends Thread
	{
		...
		public void run()
		{
			try
			{
				List<DelayJitterLossDataTO> list = da.getDelayJitterLossData(request);
